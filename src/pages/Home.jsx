...
const FAQ_DATA = import.meta.env.VITE_APP_MODE === 'trial' ? [
  { q: 'How do votes work?', a: 'Votes are added to your account balance. You can then distribute them to any user, in any amount you choose.' },
  { q: 'Can I split votes across multiple users?', a: 'Yes! Votes work like a wallet balance. Have 1,000 votes? Send 200 to one person, 300 to another — it\'s entirely up to you.' },
  { q: 'How quickly are votes delivered?', a: 'Votes are delivered instantly after you send them to a recipient.' },
  { q: 'Is there a limit to how many votes I can send?', a: 'There\'s no minimum or maximum when sending votes — you can send as few as 1 vote at a time.' },
  { q: 'Do votes expire?', a: 'Unused votes remain in your balance indefinitely.' },
] : [
